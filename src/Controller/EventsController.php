...
class EventsController extends AbstractController
{
    ...
    public function index(EventsRepository $eventsRepository, EventTypeRepository $eventtypeRepository): Response
    {
        return $this->render('events/index.html.twig', [
            'events' => $eventsRepository->findAll(),
            'types' => $eventtypeRepository->findAll(),
        ]);
    }

    #[Route('/type/{type}', name: 'app_events_filter', methods: ['GET'])]
    public function filterType(EventsRepository $eventsRepository, EventTypeRepository $eventtypeRepository, $type): Response
    {
